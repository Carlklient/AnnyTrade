...
import { suspendUserAsAdmin } from "@/features/annytrade/server/admin/users";
...
export async function POST(
  ...
  return handleApi(
    ...
    async () => {
      ...
      const result = await suspendUserAsAdmin(admin, id, parsed.data.reason);
      return { body: result };
    },
    {
      rateLimit: { scope: "admin-suspend", limit: 20, windowMs: 60_000 },
    },
  );
}
